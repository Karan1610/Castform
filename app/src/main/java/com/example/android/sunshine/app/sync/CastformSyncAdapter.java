...
public class CastformSyncAdapter extends AbstractThreadedSyncAdapter {
    public final String LOG_TAG = CastformSyncAdapter.class.getSimpleName();
    ...
    public CastformSyncAdapter(Context context, boolean autoInitialize) {
    ...
    private static void onAccountCreated(Account newAccount, Context context) {
         ...
         */
        CastformSyncAdapter.configurePeriodicSync(context, SYNC_INTERVAL, SYNC_FLEXTIME);
