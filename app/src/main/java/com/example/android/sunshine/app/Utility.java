...
/**
 * Created by Karan on 24-11-2016.
 */
...
import com.example.android.sunshine.app.sync.CastformSyncAdapter;
...
public class Utility {
    ...
    static public @CastformSyncAdapter.LocationStatus
    int getLocationStatus(Context c){
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(c);
        return sp.getInt(c.getString(R.string.pref_location_status_key), CastformSyncAdapter.LOCATION_STATUS_UNKNOWN);
    }

    /**
     * Resets the location status.  (Sets it to CastformSyncAdapter.LOCATION_STATUS_UNKNOWN)
     * @param c Context used to get the SharedPreferences
     */
    static public void resetLocationStatus(Context c){
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(c);
        SharedPreferences.Editor spe = sp.edit();
        spe.putInt(c.getString(R.string.pref_location_status_key), CastformSyncAdapter.LOCATION_STATUS_UNKNOWN);
        spe.apply();
    }
}