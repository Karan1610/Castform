...
public class SettingsActivity extends PreferenceActivity
    ...
    private void setPreferenceSummary(Preference preference, Object value) {
        ...
        if (preference instanceof ListPreference) {
            ...
            @CastformSyncAdapter.LocationStatus int status = Utility.getLocationStatus(this);
            switch (status) {
                case CastformSyncAdapter.LOCATION_STATUS_OK:
                    preference.setSummary(stringValue);
                    break;
                case CastformSyncAdapter.LOCATION_STATUS_UNKNOWN:
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if ( key.equals(getString(R.string.pref_location_key)) ) {
            ...
            CastformSyncAdapter.syncImmediately(this);
